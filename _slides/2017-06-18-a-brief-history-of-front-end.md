...
## 前端发展总结
 ...
 阶段 | 时间  |  背景   | 代表技术 | 前端内容  | 网页生成
-----|------|---------|--------|----------|---------
 起步 | ~1994| HTML格式|   HTM   | HTML文档 | 无
动态化| ~1996|浏览器CGI |  PHP等  | 后端模板 | 后端渲染
 发展 | ~2006| HTML4  | CSS,AJAX| 模板和样式| 后端为主
 统一 | ~2010| ECMA年更|jQurey等库| JS和模板| 后端和前端
 爆发 | 到目前| npm,HTML5|前端框架 | Web APP| 前端渲染
